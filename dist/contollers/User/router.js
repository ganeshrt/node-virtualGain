...
router.post('/', authenticate_1.authJWt, handleMulter_1.upload.single('productImage'), check_1.checkSchema(validation_1.default.user.post), controllerAdapter_1.default(UserController_1.default, "createUser"));
